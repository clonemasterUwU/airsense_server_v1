...
export default async()=>{
  try{
    ...
    await pool.query(
      `INSERT INTO Node(NodeId,Longtitude,Latitude,active,ReverseGeocode) VALUES(?,?,?,?,?)`
    ...
    await pool.query(
      `INSERT INTO Node(NodeId,Longtitude,Latitude,active,ReverseGeocode) VALUES(?,?,?,?,?)`
    ,['BCDDC26C4CF4', 105.783636, 21.045914, true, '479 Hoàng Quốc Việt, Cổ Nhuế, Cầu Giấy, Hà Nội, Việt Nam'])
    await pool.query(
      `INSERT INTO Node(NodeId,Longtitude,Latitude,active,ReverseGeocode) VALUES(?,?,?,?,?)`
    ...
    await pool.query(
      `INSERT INTO Node(NodeId,Longtitude,Latitude,active,ReverseGeocode) VALUES(?,?,?,?,?)`
    ,['DC4F227E6793', 105.815629, 21.078539, false, '28 D3 A4 Ngõ 689 Lạc Long Quân,, Phú Thượng, Tây Hồ, Hà Nội, Việt Nam'])
    await pool.query(
      `INSERT INTO Node(NodeId,Longtitude,Latitude,active,ReverseGeocode) VALUES(?,?,?,?,?)`
    ...
    await pool.query(`DELETE FROM data where NodeId IN (
      ...
      'DC4F2222BA72', 'DC4F2222F3A0', 'DC4F227D3716', 'DC4F227DC8A9','DC4F227DC8F1',
      ...
      'DC4F227E6793', 'DC4F227E67C4', 'DC4F227E684B', 'DC4F227E689E', 'ECFABC2C6A31', 
      ...
      '4C11AE10C0A6', '4C11AE10CA5F', '5002914ED2D3', '50029167E731'
      );
      `)
  }catch(err){
